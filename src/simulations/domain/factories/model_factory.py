...
class ModelFactory(Factory):
    ...
    def new() -> AIModel:
        ...
        model_layers = [tf.keras.layers.Dense(128, activation='relu', name="dense_1"),
                        tf.keras.layers.Dense(128, activation='relu', name="dense_2"),
                        tf.keras.layers.Dropout(.75, input_shape=(128, 1), name="dropout_1"),
                        tf.keras.layers.Dense(64, activation='relu', name="s_dense_1"),
